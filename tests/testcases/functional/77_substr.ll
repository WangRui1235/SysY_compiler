; ModuleID = 'cminus'
source_filename = "/home/hq/SysY/tests/testcases/functional/77_substr.sy"
...
label_entry:
  ...
  %op62 = trunc i32  10 to i8 
  call void @putch(i8  %op62)
  %op63 = getelementptr [15 x i32 ], [15 x i32 ]* %op0, i32  0, i32  0
  %op64 = getelementptr [13 x i32 ], [13 x i32 ]* %op31, i32  0, i32  0
  %op65 = call i32  @longest_common_subseq(i32 * %op63, i32  15, i32 * %op64, i32  13)
